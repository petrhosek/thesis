...
\begin{figure}[!t]
 \centering
 \includegraphics[width=\textwidth]{efficient-execution/graphs/redis}
 \caption{Performance overhead for individual \redis operations
   for 0, 3 and 6 followers. The client and server are located on the same
   rack, simulating a worst-case scenario.}
 \label{fig:redis-ops}
\end{figure}
