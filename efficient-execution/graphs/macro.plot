set term pdfcairo noenhanced color solid font 'MyriadPro,12' size 17.0cm,8.0cm
...
plot newhistogram "C10k", 'c10k.dat' using 2:xticlabels(1) linecolor rgb "#666666", \
      ...
      newhistogram "Comparison", 'comparison.dat' using 2:xticlabels(1) linecolor rgb "#666666" notitle, \
