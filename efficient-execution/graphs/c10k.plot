...
plot 'c10k.dat' using 2:xticlabels(1) linecolor rgb "#666666", \
             ...
             '' using 3:xticlabels(1) linecolor rgb "#777777", \
	           '' using 0:3:3 with labels left offset -2.75,0.25 rotate by 90 font "Myriad Pro,11" notitle, \
             '' using 4:xticlabels(1) linecolor rgb "#888888", \
	           '' using 0:4:4 with labels left offset -1.5,0.25 rotate by 90 font "Myriad Pro,11" notitle, \
             '' using 5:xticlabels(1) linecolor rgb "#999999", \
	           '' using 0:5:5 with labels left offset -0.35,0.25 rotate by 90 font "Myriad Pro,11" notitle, \
             '' using 6:xticlabels(1) linecolor rgb "#AAAAAA", \
	           '' using 0:6:6 with labels left offset 0.85,0.25 rotate by 90 font "Myriad Pro,11" notitle, \
             '' using 7:xticlabels(1) linecolor rgb "#BBBBBB", \
	           '' using 0:7:7 with labels left offset 2.05,0.25 rotate by 90 font "Myriad Pro,11" notitle, \
             '' using 8:xticlabels(1) linecolor rgb "#CCCCCC", \
	           '' using 0:8:8 with labels left offset 3.25,0.25 rotate by 90 font "Myriad Pro,11" notitle
