...
\newcommand{\nginxIntercept}{\SI{3}{\percent}\xspace}
\newcommand{\beanstalkdIntercept}{\SI{11}{\percent}\xspace}
...
\newcommand{\redisNoSanitizationMedianLength}{\num{2}\xspace}
\newcommand{\redisSanitizationMedianLength}{\num{6}\xspace}
\newcommand{\redisNoSanitizationAverageLength}{\num{3}\xspace}
