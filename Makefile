...
THESIS_SRCS += evolution/results/beanstalkd.tex
THESIS_SRCS += evolution/results/lighttpd1.4.tex
THESIS_SRCS += evolution/results/lighttpd2.tex
...
THESIS_PLOTS += evolution/graphs/traces.plot
