\section{Solution}\marginnote{1}[-3em]
...
of all the versions has to be the same.\marginnote{4} The empirical study
...
independent requests, such as network servers.\marginnote{4} These applications
