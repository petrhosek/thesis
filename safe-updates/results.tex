\newcommand{\mxSLOC}[0]{\SI{28200}{\loc}\xspace}
...
\newcommand{\lighttpdMinPatch}[0]{\SI{1}{\loc}\xspace} 

% size of the smallest patch
\newcommand{\lighttpdMaxPatch}[0]{\SI{2959}{\loc}\xspace} 

% size of the patch median
\newcommand{\lighttpdMedPatch}[0]{\SI{33}{\loc}\xspace} 
...
% lower bound
\newcommand{\lighttpdOneLB}[0]{2436\xspace}
% upper bound
\newcommand{\lighttpdOneUB}[0]{2523\xspace}
...
% lower bound
\newcommand{\lighttpdTwoLB}[0]{2696\xspace}
% upper bound
\newcommand{\lighttpdTwoUB}[0]{2708\xspace}
...
\newcommand{\numSPECbench}[0]{\num{29}\xspace}
\newcommand{\maxOverSPECNoCkpt}[0]{\SI{3.23}{\percent}\xspace}
\newcommand{\minOverSPECNoCkpt}[0]{\SI{55.95}{\percent}\xspace}
\newcommand{\avgOverSPECNoCkpt}[0]{\SI{18.75}{\percent}\xspace}
\newcommand{\minOverSPEC}[0]{\SI{3.43}{\percent}\xspace}
\newcommand{\maxOverSPEC}[0]{\SI{105.16}{\percent}\xspace}
\newcommand{\avgOverSPEC}[0]{\SI{17.91}{\percent}\xspace}

\newcommand{\avgOverhead}[0]{\SI{17.9}{\percent}\xspace}

% coreutils overhead
% mkdir a
\newcommand{\avgMkdirNative}[0]{\SI{1}{\milli\second}\xspace}
\newcommand{\avgMkdirMx}[0]{\SI{4}{\milli\second}\xspace}
