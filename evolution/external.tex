...
allow the use of the Linux \textstt{perf}
...
\textstt{perf} is implemented largely in the kernel while \textstt{strace} uses
...
applications such as \redis, as the \textstt{perf} tool uses a custom binary
format which contains a large number of additional information compared to the
simple textual output of \textstt{strace}.
...
System call traces generated by \textstt{perf} were normalised and
