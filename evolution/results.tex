...
\newcommand{\lighttpdCompileTime}[0]{17\xspace}
\newcommand{\lighttpdTestTime}[0]{3\xspace}
...
\renewcommand{\lighttpdLatentOne}[0]{0.9\%\xspace}
\renewcommand{\lighttpdLatentFive}[0]{5.0\%\xspace}
\renewcommand{\lighttpdLatentTen}[0]{6.1\%\xspace}
